...
public class TamanrassetGameUtils implements GameProcessInterface {
    private final Activity activity;

    public TamanrassetGameUtils(Activity activity) {
    ...
    public void showMainElements(View viewToShow) {
        ...
        img_current_city.setImageDrawable(activity.getResources().getDrawable(R.drawable.stop_tamanrasset));
        img_current_stop.setImageDrawable(activity.getResources().getDrawable(R.drawable.stop_number_5));
        img_current_map_element.setImageResource(R.drawable.img_map_tamanrasset);
        animToShowViews(viewToShow);
    }
    ...
    public void showQuizListProgress(View cl_with_progress, int currentLevel) {
        ...
        if (currentLevel > 40 && currentLevel <= 50) {
            ...
            ll_tamanrasset_progress.setEnabled(true);
            ll_tamanrasset_progress.setBackground(currentLayout);
            tamanrasset_progress_bar.setProgressText(10);
            tamanrasset_progress_bar.setProgress(currentLevel - 40);
            tamanrasset_progress_bar.setVisibility(View.VISIBLE);
    ...
    public void showViewForStudy(View viewToShow) {
        ...
        tv_header_for_study_about_current_stop.setText(activity.getResources().getString(R.string.txt_tamanrasset));
        tv_main_txt_for_study_about_current_stop.setText(TXT_MAIN_TAMANRASSET);
        animToShowViews(viewToShow);
    }
    ...
    public void showQuestionOnView(View cl_with_quiz_question, int currentLevel) {
        ...
        switch (currentLevel) {
            case 41:
                tv_main_question.setText(FIRST_QUESTION_TAMANRASSET);
                animToShowViews(cl_with_quiz_question);
                break;
            case 42:
                tv_main_question.setText(SECOND_QUESTION_TAMANRASSET);
                animToShowViews(cl_with_quiz_question);
                break;
            case 43:
                tv_main_question.setText(THIRD_QUESTION_TAMANRASSET);
                animToShowViews(cl_with_quiz_question);
                break;
            case 44:
                tv_main_question.setText(FORTH_QUESTION_TAMANRASSET);
                animToShowViews(cl_with_quiz_question);
                break;
            case 45:
                tv_main_question.setText(FIFTH_QUESTION_TAMANRASSET);
                animToShowViews(cl_with_quiz_question);
                break;
            case 46:
                tv_main_question.setText(SIXTH_QUESTION_TAMANRASSET);
                animToShowViews(cl_with_quiz_question);
                break;
            case 47:
                tv_main_question.setText(SEVENTH_QUESTION_TAMANRASSET);
                animToShowViews(cl_with_quiz_question);
                break;
            case 48:
                tv_main_question.setText(EIGHTH_QUESTION_TAMANRASSET);
                animToShowViews(cl_with_quiz_question);
                break;
            case 49:
                tv_main_question.setText(NINTH_QUESTION_TAMANRASSET);
                animToShowViews(cl_with_quiz_question);
                break;
            case 50:
                tv_main_question.setText(TENTH_QUESTION_TAMANRASSET);
                animToShowViews(cl_with_quiz_question);
                break;
        }
    }
    ...
    public void showInfoAboutCurrentPlace(View cl_with_info_about_current_city, int currentLevel) {
        if (currentLevel > 40 && currentLevel <= 50) {
            ...
            tv_header_current_city_marker.setText(R.string.txt_tamanrasset);
            tv_main_text_current_city_marker.setText(TXT_MAIN_TAMANRASSET);
